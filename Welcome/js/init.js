		...
		plugins: {
			layers: {
				...
				topPanel: {
					...
					width: '100%',
					height: 275,
					html: '<nav Dao-action="navList" Dao-args="nav"></nav>',
					clickToHide: true,
					swipeToHide: false,
				...
				topButton: {
					...
					width: 120,
					height: 50,
					html: '<span class="toggle" Dao-action="toggleLayer" Dao-args="topPanel"></span>'
				},
				sidePanel: {
				...
				sideButton: {
					...
					width: 100,
					height: 60,
					html: '<span class="toggle" Dao-action="toggleLayer" Dao-args="sidePanel"></span>'
				}
			}
		}
	});
